        ...
        <div>
            <footer className="text-gray-600 body-font bg-gray-100 ">
                <div className="container px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-10 md:pl-10 mx-auto text-center md:text-left">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <Image height={150} width={170} src="/images/logo.png" alt="" />
                        </a>
                        <p className="mt-2 text-sm text-gray-500">Your Coding Clothes Adda</p>
                    </div>
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 text-left">
                        <div className="lg:w-1/4 w-1/2 md:w-full pl-7">
                        ...
                        <div className="lg:w-1/4 w-1/2 md:w-full ">
                        ...
                        <div className="lg:w-1/5 w-full text-center md:text-left">
                ...
                <div>
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 Ecloud Adda - All rights reserved
                        </p>
